...
INSERT INTO TiposUsuario (NomeTipo)
...
VALUES ('SALVADOR (5 DIAS / 4 DIÁRIAS)'
		,'O que não falta em Salvador são atrações. Prova disso são as praias, os
		...
		estrangeiros. O Pelourinho e o Elevador são alguns dos principais pontos de visitação.'
		,'06-08-2020','10-08-2020',854.00,1,'Salvador')
		,('RESORTS NA BAHIA - LIROTRAL NORTE (5 DIAS / 4 DIÁRIAS)'
		,'O Litoral Norte da Bahia conta com
		...
		,'14-05-2020','18-05-2020',1826.00,1,'Salvador')
		,('BONITO VIA CAMPO GRANDE, 1 PASSEIO (5 DIAS/4 DIÁRIAS)'
		,'Localizado no estado de Mato Grosso do
		...
		ecológicas, passeios de bote e descidas de rapel pelas inúmeras quedas dágua da
		região.'
		,'28-03-2020','01-04-2020',1004.00,1,'Bonito')
GO